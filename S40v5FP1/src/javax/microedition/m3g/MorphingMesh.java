...
public class MorphingMesh extends Mesh {
   ...
   public MorphingMesh(VertexBuffer var1, VertexBuffer[] var2, IndexBuffer var3, Appearance var4) {
      ...
      this.O = new VertexBuffer[var2.length];
      System.arraycopy(var2, 0, this.O, 0, var2.length);
   }
   ...
   MorphingMesh(int var1) {
      super(var1);
      this.O = new VertexBuffer[_getMorphTargetCount(var1)];

      for(int var2 = 0; var2 < this.O.length; ++var2) {
         this.O[var2] = (VertexBuffer)getInstance(_getMorphTarget(var1, var2));
      }
   ...
   private static int a(VertexBuffer var0, VertexBuffer[] var1, IndexBuffer var2, Appearance var3) {
      a(var0, var2);
      ...
      int[] var8;
      (var8 = new int[1])[0] = var2.handle;
      if (var3 != null) {
         (var6 = new int[1])[0] = var3.handle;
      }
