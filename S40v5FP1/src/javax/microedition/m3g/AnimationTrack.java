...
public class AnimationTrack extends Object3D {
   ...
   private AnimationController T;
   private KeyframeSequence U;

   AnimationTrack(int var1) {
      super(var1);
      this.T = (AnimationController)getInstance(_getController(var1));
      this.U = (KeyframeSequence)getInstance(_getSequence(var1));
   }
