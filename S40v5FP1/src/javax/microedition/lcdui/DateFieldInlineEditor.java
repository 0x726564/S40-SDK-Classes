...
class DateFieldInlineEditor implements DateEditor {
   ...
   public void init(DateField owner, String title) {
      this.owner = owner;
   }
   ...
   public boolean processKey(int keyCode) {
      String currentDateStr = this.toString();
      int fieldType = false;
      DateInputField dif;
      int fieldType;
      switch(keyCode) {
      ...
      if (!strNew.equals(currentDateStr)) {
   ...
   static {
      DATEFIELD_DATE_ADVICE_ZONE = Displayable.uistyle.getZone(47);
      DATEFIELD_DATE_EDIT_ZONE = Displayable.uistyle.getZone(48);
      DATEFIELD_TIME_ADVICE_ZONE = Displayable.uistyle.getZone(49);
      DATEFIELD_TIME_EDIT_ZONE = Displayable.uistyle.getZone(50);
