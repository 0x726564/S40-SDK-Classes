...
public class Display {
   ...
   private Display(MIDlet m) {
      ...
      synchronized(LCDUILock) {
         ...
         List.resetDisplayInExplorersList();
         defaultDisplayable.myDisplay = null;
   ...
   public void setCurrent(Displayable nextDisplayable) {
      if (nextDisplayable != null) {
         try {
            this.setCurrent(nextDisplayable, false, (String)null);
   ...
   void setCurrent(Displayable nextDisplayable, boolean immediateFg, String softnoteText) throws ForegroundUnavailableException {
      synchronized(LCDUILock) {
         if (this == theActiveDisplay) {
            if (nextDisplayable != null) {
               if (!(nextDisplayable instanceof Alert)) {
                  ...
                  if (this.foldClosed && displayActive && !this.nativeIsNoteDisplayed()) {
                     this.displayNote((Alert)nextDisplayable);
                  }
               }
            }

            this.setCurrentImpl((Displayable)null, nextDisplayable, (Item)null, immediateFg, softnoteText, true, false);
         }
   ...
   public void setCurrent(Alert alert, Displayable nextDisplayable) {
      try {
         this.setCurrent(alert, nextDisplayable, false, (String)null);
      } catch (ForegroundUnavailableException var4) {
      }

   }

   void setCurrent(Alert alert, Displayable nextDisplayable, boolean immediateFg, String softnoteText) throws ForegroundUnavailableException {
            ...
            synchronized(LCDUILock) {
               if (this == theActiveDisplay) {
                  ...
                  if (this.foldClosed && !this.nativeIsNoteDisplayed() && displayActive) {
                     this.displayNote(alert);
                  }

                  this.setCurrentImpl((Displayable)null, alert, (Item)null, immediateFg, softnoteText, true, false);
               }
   ...
   void setCurrentItem(Item item, boolean immediateFg, String softnoteText) throws ForegroundUnavailableException {
      synchronized(LCDUILock) {
         ...
         if (nextDisplayable != null && !(nextDisplayable instanceof Alert)) {
            if (this == theActiveDisplay) {
               this.setCurrentImpl((Displayable)null, nextDisplayable, nextDisplayable instanceof Form ? item : null, immediateFg, softnoteText, true, false);
            }
   ...
   void requestRepaint(Displayable d, int x, int y, int w, int h) {
      synchronized(LCDUILock) {
         if (this == theActiveDisplay && d.isShown() && this.stateOfRepaint != 2) {
   ...
   void requestFullRepaint(Displayable d) {
      synchronized(LCDUILock) {
         if (this == theActiveDisplay && d.isShown()) {
            if (this.stateOfRepaint == 0) {
               JavaEventGenerator.s_generateEvent(0, 2, 2, layout);
            }
   ...
   void setCurrentInternal(Displayable parentDisplayable, Displayable nextDisplayable) {
      if (nextDisplayable != null && (nextDisplayable.isSystemScreen() || parentDisplayable == null)) {
         if (this == theActiveDisplay) {
            ...
            try {
               this.setCurrentImpl(parentDisplayable, nextDisplayable, (Item)null, false, (String)null, false, false);
            } catch (ForegroundUnavailableException var4) {
            }
         }
   ...
   final void consumeUIEvent(int type, int param) {
      ...
      if (localCurrentDisplayable != null && localCurrentDisplayable.isShown()) {
         makeCallOut = true;
      }

      if (makeCallOut) {
         int keyCode = (short)(param & '\uffff');
         int keyDataIdx = (short)(param >> 16 & '\uffff');
         switch(type) {
         case 1:
            localCurrentDisplayable.callKeyPressed(keyCode, keyDataIdx);
            break;
         case 2:
            localCurrentDisplayable.callKeyRepeated(keyCode, keyDataIdx);
            break;
         case 3:
            localCurrentDisplayable.callKeyReleased(keyCode, keyDataIdx);
         }
      }
   ...
   void flushImageToScreen(Displayable d, Image image, int x, int y, int w, int h) {
      if (this == theActiveDisplay && displayIsVisible && d.isShown() && this.displayGraphics != null && !this.screenChangeInProgress && image.getPixmap().isGameCanvasPixmap()) {
         int clipY = 0;
         Zone tZone = d.getTickerZone();
         if (tZone != null) {
            clipY = tZone.y + tZone.height + tZone.getMarginTop() + tZone.getMarginBottom();
         }
   ...
   private static void changeDisplayLayoutImpl(Displayable displayable) {
         ...
         label152: {
            ...
            if (this.stateOfScreenChange == 1) {
               ...
               if (this.currentDisplayable.setDisplayableToTopOfStack(this.pendingParentDisplayable, this.pendingDisplayable) || this.currentDisplayable == defaultDisplayable && this.pendingDisplayable == defaultDisplayable && !defaultDisplayable.isShown()) {
                  ...
                  oldDisplayableShown = this.currentDisplayable.isShown();
   ...
   private void displayNote(Alert alert) {
      this.nativeDisplayNote();
      alert.startTone(this);
   }
   ...
   private void setCurrentImpl(Displayable parentDisplayable, Displayable nextDisplayable, Item nextItem, boolean immediateFg, String softNoteText, boolean isMidletScreenChange, boolean suppressBgFg) throws ForegroundUnavailableException {
      ...
      if (!barbiePlatform && nextDisplayable != null) {
         ...
         if (isMidletScreenChange) {
            proceedWithScreenChange = this.requestDisplayStateChange(midletId, false, immediateFg, (String)null);
         ...
         proceedWithScreenChange = this.requestDisplayStateChange(midletId, true, immediateFg, softNoteText);
         eventPrePosted = true;
      }
      ...
      if (proceedWithScreenChange) {
         ...
         case 0:
            if (nextDisplayable == this.currentDisplayable && nextItem == null && (this.currentDisplayable != defaultDisplayable || defaultDisplayable.isShown())) {
               return;
            }
   ...
   private native boolean requestDisplayStateChange(int var1, boolean var2, boolean var3, String var4);
   ...
   private class DisplayAccessor implements DisplayAccess, EventConsumer, CommandListener {
            ...
            if (Display.this == Display.theActiveDisplay) {
               ...
               synchronized(Display.LCDUILock) {
                  if (Display.this.stateOfScreenChange == 0 && Display.this.currentDisplayable == Display.defaultDisplayable) {
                     try {
                        Display.this.setCurrentImpl((Displayable)null, Display.this.currentDisplayable, (Item)null, false, (String)null, false, true);
      ...
      public void setCurrent(Display display, Displayable nextDisplayable, boolean immediateFg, String promptText) throws ForegroundUnavailableException {
         if (display != Display.theActiveDisplay) {
            ...
            Display.this.setCurrent(nextDisplayable, immediateFg, promptText);
         }
      }
      ...
      public void setCurrent(Display display, Alert alert, Displayable nextDisplayable, boolean immediateFg, String promptText) throws ForegroundUnavailableException {
         if (display != Display.theActiveDisplay) {
            ...
            Display.this.setCurrent(alert, nextDisplayable, immediateFg, promptText);
         }
      }
