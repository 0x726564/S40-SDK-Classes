...
public class UIStyle {
   ...
   public void drawEditableTextWithBorder(Graphics graphics, Zone zone, int translateX, int translateY, TextLine text, int borderType, int alignment, boolean hasFocus) {
      ...
      graphics.drawText(text, (short)textOffsetX, (short)textOffsetY, (short)textWidth);
         ...
         default:
            if (index >= 0 && index <= 0) {
               ...
               if (font == null) {
                  ...
                  if (this.nativeGetFontParameters(index, f_params)) {
   ...
   private static void initialiseStyle(boolean isFirstClassLoad) {
      ...
      if (_locale != null && (_locale.equals("he-IL") || _locale.startsWith("ar") || _locale.startsWith("fa"))) {
         isAlignedLeftToRight = false;
      }

      synchronized(sharedUIStyleLock) {
         nativeInitialiser(isFirstClassLoad, isAlignedLeftToRight);
      }
