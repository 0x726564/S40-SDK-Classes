...
public abstract class BasicPlayer implements Player, TimeBase {
   ...
   public void setDataSource(JavaProducerSource source) {
   ...
   public Control getControl(String type) {
      ...
      if (type == null) {
         ...
         return this.controlManager.getControl("javax.microedition.media.control.", type);
      }
   }
