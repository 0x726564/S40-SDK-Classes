...
public final class Math {
   ...
   private static long bi = (long)Float.floatToIntBits(-0.0F);
   private static long bj = Double.doubleToLongBits(-0.0D);
   ...
   public static strictfp float max(float var0, float var1) {
      if (var0 != var0) {
         return var0;
      } else if (var0 == 0.0F && var1 == 0.0F && (long)Float.floatToIntBits(var0) == bi) {
         return var1;
      } else {
         return var0 >= var1 ? var0 : var1;
      }
   ...
   public static strictfp double max(double var0, double var2) {
      if (var0 != var0) {
         return var0;
      } else if (var0 == 0.0D && var2 == 0.0D && Double.doubleToLongBits(var0) == bj) {
         return var2;
      } else {
         return var0 >= var2 ? var0 : var2;
      }
   ...
   public static strictfp float min(float var0, float var1) {
      if (var0 != var0) {
         return var0;
      } else if (var0 == 0.0F && var1 == 0.0F && (long)Float.floatToIntBits(var1) == bi) {
         return var1;
      } else {
         return var0 <= var1 ? var0 : var1;
      }
   ...
   public static strictfp double min(double var0, double var2) {
      if (var0 != var0) {
         return var0;
      } else if (var0 == 0.0D && var2 == 0.0D && Double.doubleToLongBits(var2) == bj) {
         return var2;
      } else {
         return var0 <= var2 ? var0 : var2;
      }
