...
public class WriterImpl extends Writer {
   ...
   public synchronized void write(int var1) throws IOException {
      ...
      if ((var1 = CharsetConv.charToByte(this.nativeConvInfo, var2, 0, this.buf, 0, this.buf.length)) > 0) {
   ...
   public synchronized void write(char[] var1, int var2, int var3) throws IOException {
      ...
      int var5;
      if ((var5 = CharsetConv.charArrayToByte(this.encoding, var1, var2, var3, this.buf, 0, this.buf.length)) > 0) {
   ...
   public void flush() throws IOException {
      int var1;
      if ((var1 = this.flushStream(this.nativeConvInfo, this.buf, this.buf.length)) > 0) {
         this.out.write(this.buf, 0, var1);
      }
