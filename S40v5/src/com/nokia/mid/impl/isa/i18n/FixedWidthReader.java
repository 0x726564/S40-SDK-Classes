...
public class FixedWidthReader extends ReaderImpl {
   ...
   public synchronized int read(char[] var1, int var2, int var3) throws IOException {
      ...
      int var5;
      if ((var5 = this.in.read(var4)) == -1) {
         return -1;
      } else {
         int var6;
         if ((var6 = CharsetConv.byteToCharArray(this.encoding, var4, 0, var5, var1, var2, var3)) < 0) {
   ...
   public long skip(long var1) throws IOException {
      if (var1 < 0L) {
         ...
         return this.in.skip(var1 * (long)this.maxByteLen) / (long)this.maxByteLen;
      }
   }
}
