...
public class SVGLocatableElementImpl extends SVGElementImpl implements SVGLocatableElement {
   ...
   public SVGRect getBBox() {
      SVGRectImpl var1;
      float[] var2 = (var1 = new SVGRectImpl(0.0F, 0.0F, 0.0F, 0.0F)).getArray();
      SVGElementImpl._getRectTrait(this.myElement, (short)59, var2);
      if ((this.elementType == 14 || this.elementType == 22 || this.elementType == 29 || this.elementType == 27) && var1.getArray()[0] == 0.0F && var1.getArray()[1] == 0.0F && var1.getArray()[2] == 0.0F && var1.getArray()[3] == 0.0F) {
         var1 = null;
      }

      if (this.elementType == 29 && this.getTrait("#text").length() <= 0) {
         var1 = null;
      }
   ...
   public SVGRect getScreenBBox() {
      ...
      if (_elementInDOM(super.getDocumentHandle(), this.myElement)) {
         ...
         return (double)var1[0] == 0.0D && (double)var1[1] == 0.0D && (double)var1[2] == 0.0D && (double)var1[3] == 0.0D ? null : new SVGRectImpl(var1[0], var1[1], var1[2], var1[3]);
      } else {
         return null;
      }
   }
