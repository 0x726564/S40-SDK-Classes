...
public class SVGElementImpl implements SVGElement {
   ...
   public float getFloatTrait(String var1) {
      if (var1 != null && !var1.equals("")) {
         short var2;
         if ((var2 = stringToEnumTrait(var1)) != -1 && checkTraitOnElement(this.elementType, var2)) {
            boolean var10000;
            switch(var2) {
            case 67:
            case 68:
      ...
      if (var1 != null && !var1.equals("")) {
         ...
         if ((var2 = stringToEnumTrait(var1)) != -1 && checkTraitOnElement(this.elementType, var2)) {
            ...
            if (!var10000) {
               ...
               SVGMatrixImpl var4 = new SVGMatrixImpl();
               return _getMatrixTrait(this.myElement, var2, var4.getArray()) == -1 ? new SVGMatrixImpl(1.0F, 0.0F, 0.0F, 1.0F, 0.0F, 0.0F) : var4;
            }
         } else {
            throw new DOMException((short)9, "trait not supported on this element");
         }
      ...
      if (var1 != null && !var1.equals("")) {
         ...
         if ((var2 = stringToEnumTrait(var1)) != -1 && checkTraitOnElement(this.elementType, var2)) {
            ...
            if (!var10000) {
               ...
               int var4;
               return (var4 = _getPathTrait(this.myElement, var2)) != 0 ? new SVGPathImpl(var4) : null;
            }
         } else {
            throw new DOMException((short)9, "trait not supported on this element");
         }
      ...
      if (var1 != null && !var1.equals("")) {
         ...
         if ((var2 = stringToEnumTrait(var1)) != -1 && checkTraitOnElement(this.elementType, var2)) {
            ...
            if (!var10000) {
               ...
               SVGRectImpl var4 = new SVGRectImpl(0.0F, 0.0F, 0.0F, 0.0F);
               return _getRectTrait(this.myElement, var2, var4.getArray()) == -1 ? null : var4;
            }
         } else {
            throw new DOMException((short)9, "trait not supported on this element");
         }
      ...
      if (var1 != null && !var1.equals("")) {
         ...
         if ((var2 = stringToEnumTrait(var1)) != -1 && checkTraitOnElement(this.elementType, var2)) {
            ...
            if (!var10000) {
               ...
               SVGRGBColorImpl var5 = new SVGRGBColorImpl(0, 0, 0);
               int var4;
               if ((var4 = _getColorTrait(this.myElement, var2, var5.getArray())) == -1) {
                  return var2 != 74 && var2 != 64 ? null : new SVGRGBColorImpl(0, 0, 0);
               } else {
                  return var4 == 0 ? null : var5;
               }
            }
         } else {
            throw new DOMException((short)9, "trait not supported on this element");
   ...
   public String getTraitNS(String var1, String var2) {
      if (var2 != null && !var2.equals("")) {
         if (var1 != null && !var1.equals("http://www.w3.org/1999/xlink")) {
            ...
            short var3;
            if ((var3 = stringToEnumTrait(var2)) != -1 && checkTraitOnElement(this.elementType, var3)) {
               boolean var10000;
               if (var1 != null && !var1.equals("http://www.w3.org/2000/svg")) {
                  ...
                  if (!var10000) {
                     ...
                     return (var1 = _getStringTrait(this.myElement, var3)) == null ? "" : var1;
                  }
               } else {
                  switch(var3) {
                  case 58:
                  ...
                  if (!var10000) {
                     ...
                     short var4;
                     if ((var4 = _getTrait(this.myElement, var3)) == 0) {
                        return "";
                     } else if (var3 == 81 && var4 == 337) {
                        return "300";
                     } else if (var3 == 81 && var4 == 331) {
                        return "400";
                     } else if (var3 == 81 && var4 == 335) {
                        return "700";
                     } else {
                        return var3 == 81 && var4 == 336 ? "800" : enumToStringValue(var4);
                     }
                  } else {
                     return (var1 = _getStringTrait(this.myElement, var3)) == null ? "" : var1;
                  }
   ...
   public void setFloatTrait(String var1, float var2) {
      if (var1 != null && !var1.equals("")) {
         short var3;
         if ((var3 = stringToEnumTrait(var1)) != -1 && checkTraitOnElement(this.elementType, var3)) {
            boolean var10000;
            switch(var3) {
            case 67:
            case 68:
   ...
   public void setTraitNS(String var1, String var2, String var3) {
      if (var3 == null) {
         ...
         if (var1 != null && !var1.equals("http://www.w3.org/1999/xlink")) {
            ...
            short var4;
            if ((var4 = stringToEnumTrait(var2)) != -1 && checkTraitOnElement(this.elementType, var4)) {
               boolean var10000;
               if (var1 != null && !var1.equals("http://www.w3.org/2000/svg")) {
                  switch(var4) {
                  case 156:
                  ...
                  short var5;
                  if ((var5 = stringToEnumValue(var4, var3)) == -1) {
   ...
   public Element getFirstElementChild() {
      int var1;
      return (var1 = _getFirstElementChild(this.myElement)) == 0 ? null : DocumentImpl.makeJavaElementType(this.myDocument, var1);
   }

   public Element getNextElementSibling() {
      int var1;
      return (var1 = _getNextElementSibling(this.myElement)) == 0 ? null : DocumentImpl.makeJavaElementType(this.myDocument, var1);
   }
   ...
   public Node getParentNode() {
      int var1;
      return (var1 = _getParent(this.myElement)) == 0 ? null : DocumentImpl.makeJavaElementType(this.myDocument, var1);
   }
   ...
   public Node removeChild(Node var1) throws DOMException {
      if (var1 == null) {
         ...
         boolean var10000;
         switch(((SVGElementImpl)var1).elementType) {
         case 0:
         case 5:
         case 8:
         case 14:
         ...
         if (!var10000) {
            ...
            SVGElementImpl var2;
            if ((var2 = (SVGElementImpl)var1.getParentNode()) != null && var2.getHandle() == this.myElement) {
               if (_checkRemoveable(((SVGElementImpl)var1).getHandle()) == 0) {
                  ...
                  _removeChild(this.getDocumentHandle(), this.myElement, ((SVGElementImpl)var1).getHandle());
                  return var1;
               }
            } else {
   ...
   public Node insertBefore(Node var1, Node var2) {
      if (var1 == null) {
         ...
         if (!var10000) {
            ...
            String var3;
            if (((SVGElementImpl)var1).elementType != 31 || (var3 = ((SVGElementImpl)var1).getTraitNS("http://www.w3.org/1999/xlink", "href")).length() == 0 || var3.startsWith("#") && ((SVGElementImpl)var1).myDocument.getElementById(var3.substring(1)) != null) {
               if (var2 == null) {
   ...
   private static final boolean a(Node var0, Node var1) throws DOMException {
      if (var1 != null) {
         ...
         if (var1 instanceof SVGElementImpl || var1 instanceof SVGLocatableElementImpl || var1 instanceof SVGSVGElementImpl) {
            ...
            return a(var0, var1.getParentNode());
         }
      }
   ...
   public SVGElement getUsedFromElement() {
      int var1;
      return (var1 = _getUsedFromElement(this.myElement)) == 0 ? null : DocumentImpl.makeJavaElementType(this.myDocument, var1);
   }
