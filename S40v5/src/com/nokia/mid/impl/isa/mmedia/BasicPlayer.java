...
public abstract class BasicPlayer implements Player, TimeBase {
   ...
   private TimeBase fM = Manager.getSystemTimeBase();
   ...
   public synchronized void prefetch() throws MediaException {
      if (PriAccess.getInt(5) == 1 && !PolicyAccess.checkPermission("javax.microedition.media.Player", "Allow Media Access?")) {
         ...
         if (this.state < 300) {
            ...
            ResourceController.d(this);

            try {
               this.doPrefetch();
            } catch (MediaException var2) {
               ResourceController.f(this);
               throw var2;
            }
   ...
   public synchronized void start() throws MediaException {
      if (PriAccess.getInt(5) == 1 && !PolicyAccess.checkPermission("javax.microedition.media.Player", "Allow Media Access?")) {
         ...
         if (this.state < 400) {
            ...
            ResourceController.e(this);

            try {
               this.doStart();
            } catch (MediaException var2) {
               ResourceController.g(this);
               throw var2;
            }
   ...
   public synchronized long setMediaTime(long var1) throws MediaException {
      ...
      return this.doSetMediaTime(var1);
   }
