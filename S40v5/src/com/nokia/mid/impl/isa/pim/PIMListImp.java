...
abstract class PIMListImp implements PIMList {
   ...
   public int maxValues(int var1) {
      try {
         this.a(var1);
         return 1;
      } catch (UnsupportedFieldException var2) {
         return 0;
      }
   }
   ...
   final void removeItem(PIMItem var1) throws PIMException {
      if (this.open) {
         if (var1 != null) {
            if (var1.getPIMList() == this && ((PIMItemImp)var1).hasBeenCommitted) {
               if (this.getMode() == 1 || !this.a(false)) {
   ...
   protected static synchronized boolean a(int var0, int var1, boolean var2) {
      return nativeHasAccessRights(var0, var1, var2);
   }
