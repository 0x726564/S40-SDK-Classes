...
public final class TextDatabase {
   ...
   static String[] bc = new String[79];
   static String dC = System.getProperty("microedition.locale");
   ...
   static {
      UIStyle.registerReinitialiseListener(new ReinitialiseListener() {
         public void reinitialiseForForeground() {
            String var1;
            if (!(var1 = System.getProperty("microedition.locale")).equals(TextDatabase.dC)) {
               TextDatabase.dC = var1;
               TextDatabase.bc = new String[79];
            }
