...
public abstract class GeneralBase implements DataInput, DataOutput {
   ...
   public static int writeUTF(String var0, DataOutput var1) throws IOException {
      ...
      if (var3 > 65535) {
         ...
         byte[] var10;
         byte[] var10000 = var10 = new byte[var3 + 2];
         int var9 = var5 + 1;
         var10000[0] = (byte)(var3 >>> 8);
         ++var9;
         var10[1] = (byte)var3;

         for(int var7 = 0; var7 < var2; ++var7) {
            if ((var8 = var4[var7]) >= 1 && var8 <= 127) {
               var10[var9++] = (byte)var8;
            } else if (var8 > 2047) {
               var10[var9++] = (byte)(224 | var8 >> 12 & 15);
               var10[var9++] = (byte)(128 | var8 >> 6 & 63);
               var10[var9++] = (byte)(128 | var8 & 63);
            } else {
               var10[var9++] = (byte)(192 | var8 >> 6 & 31);
               var10[var9++] = (byte)(128 | var8 & 63);
            }
         }
