...
public abstract class Node extends Transformable {
   ...
   Node(int var1) {
      super(var1);
      this.Q = (Node)getInstance(_getParent(var1));
      this.R = (Node)getInstance(_getZRef(var1));
      this.S = (Node)getInstance(_getYRef(var1));
   }
   ...
   public boolean getTransformTo(Node var1, Transform var2) {
      return _getTransformTo(this.handle, var1.handle, var2 != null ? var2.s : null);
   }
