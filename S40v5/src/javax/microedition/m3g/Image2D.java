...
public class Image2D extends Object3D {
   ...
   public Image2D(int var1, int var2, int var3, byte[] var4) {
      super(_ctorSizePixels(Interface.getHandle(), var1, var2, var3, var4));
   }

   public Image2D(int var1, int var2, int var3, byte[] var4, byte[] var5) {
      super(_ctorSizePixelsPalette(Interface.getHandle(), var1, var2, var3, var4, var5));
   }

   public Image2D(int var1, int var2, int var3) {
      super(_ctorSize(Interface.getHandle(), var1, var2, var3, 5));
   }
   ...
   private static int a(int var0, Object var1) {
      if (var1 == null) {
         throw new NullPointerException();
         ...
         Image var2;
         int var8 = (var2 = (Image)var1).getWidth();
         int var3 = var2.getHeight();
         int var4 = _ctorSize(Interface.getHandle(), var0, var8, var3, 0);
         int[] var5 = new int[var8];
         boolean var7 = !var2.isMutable() || var0 != 96;

         for(int var6 = 0; var6 < var3; ++var6) {
            var2.getRGB(var5, 0, var8, 0, var6, var8, 1);
            _setScanline(var4, var6, var7, var5);
         }
