...
public abstract class GameCanvas extends Canvas {
   ...
   private Image gZ = Image.createImage(DeviceInfo.getDisplayWidth(3), DeviceInfo.getDisplayHeight(3));
   private DisplayAccess ha;
   ...
   public void flushGraphics(int var1, int var2, int var3, int var4) {
      if (var3 > 0 && var4 > 0) {
         if (this.ha != null) {
            this.ha.flushImageToScreen(this, this.gZ, var1, var2, var3, var4);
            return;
         }

         MIDletAccess var5;
         if ((var5 = InitJALM.s_getMIDletAccessor()) != null && (this.ha = var5.getDisplayAccessor()) != null) {
            this.ha.flushImageToScreen(this, this.gZ, var1, var2, var3, var4);
         }
      }
