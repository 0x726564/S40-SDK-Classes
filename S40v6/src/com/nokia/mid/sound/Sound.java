...
public class Sound {
   ...
   private void initToneBuzzer(int freq, long duration) throws IllegalArgumentException {
      if (duration > 0L && freq <= 7692 && freq >= 0) {
         ...
         long tmpDuration = this.duration * 6L;
         byte tempoLowbyte = (byte)((int)(tmpDuration & 255L));
         byte tempoMidByte = (byte)((int)((tmpDuration & 65280L) >>> 8));
         byte tempoHighByte = (byte)((int)((tmpDuration & 16711680L) >>> 16));
         byte[] dummy_midi = new byte[]{77, 84, 104, 100, 0, 0, 0, 6, 0, 1, 0, 2, 0, 96, 77, 84, 114, 107, 0, 0, 0, 19, 0, -1, 88, 4, 4, 2, 24, 8, 0, -1, 81, 3, tempoHighByte, tempoMidByte, tempoLowbyte, 0, -1, 47, 0, 77, 84, 114, 107, 0, 0, 0, 15, 0, -63, 77, 0, -111, this.note, 127, 16, -111, this.note, 0, 0, -1, 47, 0};
