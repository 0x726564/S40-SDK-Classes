...
public class DeviceInfo {
   ...
   public static final int JAM_DISPLAY_MODE_SCREEN_TICKER = 4;
   public static final int JAM_DISPLAY_MODE_TIMED_ALERT_TICKER = 5;
   public static final int JAM_DISPLAY_MODE_CANVAS_TICKER = 6;
