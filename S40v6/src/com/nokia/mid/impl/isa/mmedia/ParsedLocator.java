...
public class ParsedLocator {
   ...
   public static final byte LOCATOR = 3;
   ...
   private String fullLocator = null;
   ...
   public String getParamValueAsString(String param) {
      ...
      for(int index = this.params == null ? -1 : this.params.indexOf(param); index != -1; index = this.params.indexOf(param, index + 1)) {
         if (index % 2 == 0) {
   ...
   public String getBasicLocator() {
      if (this.createdBy == 3) {
         return this.locatorType != 9 ? this.protocol + "://" + this.schemePart : this.fullLocator;
      } else {
         return null;
      }
   }
