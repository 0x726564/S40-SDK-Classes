...
public class ServerProtocol implements LocalMessageProtocolServerConnection, ConnectionBaseInterface, ServiceArchitectureServerConnection {
   ...
   public LocalMessageProtocolConnection acceptAndOpen() throws IOException {
