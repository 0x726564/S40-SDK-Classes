...
public class SslSecurityInfo implements SecurityInfo {
   ...
   public SslSecurityInfo(Protocol sslInstance) {
      this.cipher_suite = this.getCipherSuite0(sslInstance);
      this.cert = new NetworkCertificate(this.getCertificateId0(sslInstance));
   }
