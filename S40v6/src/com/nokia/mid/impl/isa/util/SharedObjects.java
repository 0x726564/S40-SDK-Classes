...
public final class SharedObjects {
   ...
   private static void put(String key, Object value, boolean useStrongReference) {
   ...
   private static Hashtable createTable() {
      ...
      t.put("com.nokia.mid.impl.isa.vm.globalLock", new S40GlobalAPILock());
      t = nativeSetTable(t);
      return t;
   }
