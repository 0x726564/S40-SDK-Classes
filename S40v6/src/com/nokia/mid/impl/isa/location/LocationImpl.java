...
public class LocationImpl extends Location {
   ...
   public QualifiedCoordinates getQualifiedCoordinates() {
      if (this.isValid() && this.coordinates != null) {
         try {
            QualifiedCoordinates qc = new QualifiedCoordinates(this.coordinates.getLatitude(), this.coordinates.getLongitude(), this.coordinates.getAltitude(), this.coordinates.getHorizontalAccuracy(), this.coordinates.getVerticalAccuracy());
            return qc;
   ...
   public String getExtraInfo(String mimetype) {
      return "application/X-jsr179-location-nmea".equals(mimetype) ? this.extraInfo : null;
   }
}
