...
public class PushRegistry {
   ...
   static final Object getDaylightSavingInfoLock = SharedObjects.getLock("getDaylightSavingInfoLock");
   private static final String SMS_URL = "sms://";
   private static final String MMS_URL = "mms://";
   private static final String CBS_URL = "cbs://";
   ...
   private static native boolean isProtocolSupported(String var0);
   ...
   public static void registerConnection(String connection, String midlet, String filter) throws ClassNotFoundException, IOException {
      if (filter != null && connection != null && connection.length() != 0) {
         if (!isProtocolSupported(connection)) {
            throw new ConnectionNotFoundException();
         } else {
            safeCheckPermission();
            if (connection.startsWith("sms://") || connection.startsWith("mms://") || connection.startsWith("cbs://")) {
               try {
