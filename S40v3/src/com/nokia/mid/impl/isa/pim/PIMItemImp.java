...
abstract class PIMItemImp implements PIMItem {
   ...
   public byte[] getBinary(int var1, int var2) {
      ...
      if (PriAccess.getInt(5) == 1) {
         byte[] var3 = (byte[])this.data[this.indexOfField(var1)];
      ...
      if (var4 == null) {
         ...
         if (PriAccess.getInt(5) == 1) {
            ...
            if (var5 + var6 > var4.length) {
               var7 = var4.length - var5;
            }

            byte[] var8 = new byte[var7];
            System.arraycopy(var4, var5, var8, 0, var7);
            int var9 = this.indexOfField(var1);
            this.setData(var8, var9);
         }
   ...
   abstract byte[] toSerial(String var1);
   ...
   void copyData(PIMItem var1) {
      ...
      for(int var3 = 0; var3 < var2.length; ++var3) {
         ...
         if (this.list.isSupportedField(var4)) {
            try {
               for(int var5 = 0; var5 < var1.countValues(var4); ++var5) {
                  int var6 = var1.getAttributes(var4, var5);
                  switch(this.list.getFieldDataType(var4)) {
                  case 0:
                     byte[] var7 = var1.getBinary(var4, var5);
                     this.addBinary(var4, var6, var7, 0, var7.length);
                     break;
                  case 1:
                     this.addBoolean(var4, var6, var1.getBoolean(var4, var5));
                     break;
                  case 2:
                     this.addDate(var4, var6, var1.getDate(var4, var5));
                     break;
                  case 3:
                     this.addInt(var4, var6, var1.getInt(var4, var5));
                     break;
                  case 4:
                     this.addString(var4, var6, var1.getString(var4, var5));
                     break;
                  case 5:
                     this.addStringArray(var4, var6, var1.getStringArray(var4, var5));
                     break;
                  default:
                     throw new RuntimeException("An error occurs");
                  }
               }
            } catch (FieldFullException var8) {
            }
         }
      }
