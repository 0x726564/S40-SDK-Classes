...
class ChoiceHandler {
   ...
   ChoiceHandler(boolean var1, boolean var2, Zone var3) {
      ...
      this.alignedL2R = UIStyle.isAlignedLeftToRight;
   ...
   void paintElements(int var1, int var2, Graphics var3, int var4) {
      ...
      if (this.choiceElements != null) {
         ...
         for(var6 = this.startElement; var6 < this.choiceElements.length && this.sumH <= var5; var6 = this.incrementIndex(var6) == this.startElement ? this.choiceElements.length : this.incrementIndex(var6)) {
   ...
   boolean needNewStarting() {
      ...
      if (this.choiceElements == null) {
         ...
         for(int var4 = this.startElement; var4 < this.choiceElements.length; var4 = this.incrementIndex(var4)) {
            ...
            var1 += (var3.lines.length - var3.startLine) * var5 + this.elementTextZone.getMarginBottom();
            var1 += var3.startLine == 0 ? this.elementTextZone.getMarginTop() : 0;
   ...
   class ChoiceElement {
      ...
      boolean setFont(Font var1) {
         ...
         this.jFont = var1;
         if (var1 == null) {
            if (this.font.getMIDPStyle() != 0) {
               this.font = ChoiceHandler.this.elementTextZone.getFont();
               var2 = true;
            }
         } else {
            int var3 = this.jFont.getStyle();
            var3 &= -5;
            if (var3 != this.font.getMIDPStyle() || this.jFont.getSize() != this.font.getMIDPSize()) {
               this.font = new com.nokia.mid.impl.isa.ui.gdi.Font(this.jFont.getSize(), var3, true);
               var2 = true;
            }
         }
      ...
      void paintElement(int var1, int var2, int var3, Graphics var4, boolean var5) {
         ...
         if (ChoiceHandler.this.mainZone != null && ChoiceHandler.this.elementTextZone != null) {
            int var9;
            if (this.highlighted && (!var5 || !UIStyle.usesBackgroundsInsteadOfBorders())) {
      ...
      private void drawElementText(int var1, int var2, com.nokia.mid.impl.isa.ui.gdi.Graphics var3) {
         ...
         if (ChoiceHandler.this.alignedL2R) {
