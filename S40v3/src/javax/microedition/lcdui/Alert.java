...
public class Alert extends Screen {
   ...
   void setImageImpl(Image var1) {
      ...
      if (var1 == null) {
         ...
         this.alertPixmap = this.getSystemImage();
      } else {
         this.usingSystemImage = false;
         if (var1.isMutable()) {
   ...
   void layout() {
      ...
      TextBreaker.breakTextInArea(this.alertPixmap != null ? this.smallTextZone.width : this.largeTextZone.width, this.indicator != null ? this.smallTextZone.height : this.largeTextZone.height, TextBreaker.NBR_OF_AREAS_AS_NEEDED, this.smallTextZone.getFont(), this.alertText, TextBreaker.DEFAULT_TEXT_LEADING, false, false, var1, false, true);
      this.displayedScreen = 0;
      this.nbrOfScreens = var1.size() > 0 && var1.elementAt(0) instanceof Vector ? var1.size() : 1;
      int var2;
      if (this.nbrOfScreens > 1) {
         for(var2 = 0; var2 < this.nbrOfScreens; ++var2) {
            this.alertTextLines.addElement((Vector)var1.elementAt(var2));
         }
      } else {
         this.alertTextLines.addElement(var1);
      }

      if (this.lastPageText != null) {
         var1 = new Vector();
         TextBreaker.breakTextInArea(this.alertPixmap != null ? this.smallTextZone.width : this.largeTextZone.width, this.indicator != null ? this.smallTextZone.height : this.largeTextZone.height, TextBreaker.NBR_OF_AREAS_AS_NEEDED, this.smallTextZone.getFont(), this.lastPageText, TextBreaker.DEFAULT_TEXT_LEADING, false, false, var1, false, true);
         var2 = var1.size() > 0 && var1.elementAt(0) instanceof Vector ? var1.size() : 1;
         if (var2 > 1) {
            for(int var3 = 0; var3 < var2; ++var3) {
               this.alertTextLines.addElement((Vector)var1.elementAt(var3));
            }
         } else {
            this.alertTextLines.addElement(var1);
         }

         this.nbrOfScreens += var2;
      }
      ...
      synchronized(Display.LCDUILock) {
         ...
         if (this.getTicker() == null || var1.getClipY() + var1.getClipHeight() >= this.borderZone.y) {
            ...
            if (this.alertTextLines.size() > 0 && !this.imageOnly) {
               ...
               var3.drawTextInArea(var4, var5, var6, var7, var9, this.alignedLeftToRight ? 1 : 3);
   ...
   private Pixmap getSystemImage() {
      ...
      if (this.alertType != null) {
         ...
         return Pixmap.createPixmap(var1);
      } else {
         return null;
      }
   }
