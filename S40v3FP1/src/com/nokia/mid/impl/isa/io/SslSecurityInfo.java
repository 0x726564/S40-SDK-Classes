...
public class SslSecurityInfo implements SecurityInfo {
   ...
   private native int getCipherSuite0(int var1);

   private native int getCertificateId0(int var1);

   public SslSecurityInfo(int var1) {
      this.cipher_suite = this.getCipherSuite0(var1);
      this.cert = new NetworkCertificate(this.getCertificateId0(var1));
   }
