...
public class Protocol implements MessageConnection, ConnectionBaseInterface {
   ...
   private static final String SMSC_NUMBER = System.getProperty("wireless.messaging.sms.smsc");
               ...
               if (var2 != 1 && var2 != 2 && var2 != 3) {
                  ...
                  if (!Protocol.SmsUrl.isServer(this.destPhoneNum, this.portNum) && var2 == 1) {
                     ...
                     synchronized(openLock) {
                        this.conId = this.SMSOpen(this.destPhoneNum, this.portNum, SMSC_NUMBER);
                     }
               ...
               if (var6 == 0) {
                  ...
                  if (Protocol.SmsUrl.isServer(this.destPhoneNum, this.portNum)) {
                     synchronized(permissionLock) {
                        var8 = phonebookLookUp(var4, true);
                     ...
                     synchronized(sendLock) {
                        this.SMSRedirect(this.conId, var3, var4);
                        this.SMSSend(this.conId, var5.getPayload(), var5.getLength(), var5.getFormat(), var4, SMSC_NUMBER, var3);
                     }
                  } else {
                     synchronized(permissionLock) {
                        var8 = phonebookLookUp(this.destPhoneNum, true);
                        if (!SMSCheckSendPermissions(var6, this.destPhoneNum, var8)) {
                           throw new SecurityException("not allowed to send");
                        }
                     }
                     ...
                     synchronized(sendLock) {
                        this.SMSSend(this.conId, var5.getPayload(), var5.getLength(), var5.getFormat(), this.destPhoneNum, SMSC_NUMBER, this.portNum);
                     }
                  }
   ...
   private int numberOfSegments(Protocol.SmsData var1, boolean var2) {
      ...
      int var5 = var2 ? MAX_NB_MSG * (var4 * 2 + 1) : MAX_NB_MSG * var4 * 2;
      int var6 = PriAccess.getInt(5) == 1 ? 1 : MAX_NB_MSG;

      for(int var7 = 0; var7 < var6; ++var7) {
         if (var3 <= NB_SMS[var5 + var7]) {
            return var7 + 1;
         }
      }
   ...
   private native int SMSOpen(String var1, int var2, String var3);
   ...
   private native void SMSRedirect(int var1, int var2, String var3);

   private native void SMSSend(int var1, byte[] var2, int var3, int var4, String var5, String var6, int var7);
