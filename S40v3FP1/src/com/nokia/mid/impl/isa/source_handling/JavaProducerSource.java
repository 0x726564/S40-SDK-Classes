...
public class JavaProducerSource implements Runnable {
   static final int JAVA_RAM_BUFFER_SIZE = 32768;
   private int activeSourceHigh = 20000;
   private int activeSourceLow = 100;
   ...
   public JavaProducerSource(String var1) throws IOException, SourceHandlingException {
      this.commonURLcode(var1);
   }

   public JavaProducerSource(String var1, int var2) throws IOException, SourceHandlingException {
      this.buffer_size = var2;
      this.commonURLcode(var1);
   }
   ...
   public void start() {
      if (this.SOURCE_CATEGORY == 2 && this.thread == null) {
   ...
   public void disconnect() {
      if (this.SOURCE_CATEGORY != 2 && this.connected) {
         try {
            this.inputStream.close();
            this.connected = false;
   ...
   public void run() {
      try {
         ...
         int var3;
         do {
            var3 = this.inputStream.read(this.buffer);
            if (var3 > 0) {
               this.writeData(this.buffer, var3);
            }
         } while(var3 != -1);
   ...
   private native void writeData(byte[] var1, int var2);
