...
public abstract class MediaOut {
   ...
   public static final byte PLAYER_USES_SOUND = 12;
   public static final byte MAX_PROPERTY = 12;
   ...
   protected abstract boolean openSession(byte[] var1, String var2, int var3, int var4);
   ...
   public boolean openDataSession(byte[] var1, String var2, int var3, int var4) {
      return !this.player.isActive() && this.openSession(var1, var2, var3, var4);
   }
