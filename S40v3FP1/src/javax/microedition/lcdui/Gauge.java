   ...
   void callPaint(Graphics var1, int var2, int var3, boolean var4) {
      ...
      synchronized(Display.LCDUILock) {
         ...
         if (this.owner instanceof Form) {
            var9 += TextBreaker.DEFAULT_TEXT_LEADING;
         }

         if (this.isInteractive) {
            this.renderInteractiveGaugeImage(var1, var2, var3, var4, valueGraphicZone);
            Displayable.uistyle.drawEditableTextWithBorder(var6, this.inlineEditZone, var7, var8 + var9, this.valueText, 2, this.focused);
         } else {
            if (UIStyle.usesBackgroundsInsteadOfBorders() && !(this.owner instanceof Alert)) {
               if (this.isFocusable()) {
                  UIStyle.getUIStyle().drawBorder(var6, var7, var8 + var9, valueGraphicZone.width, valueGraphicZone.height, 99, this.focused && this.isFocusable());
               }
            } else if (var4 && this.isFocusable()) {
               UIStyle.getUIStyle().drawHighlightBar(var6, valueGraphicZone.x + var1.translateX, valueGraphicZone.y + var9 - 1 + var1.translateY, valueGraphicZone.width, valueGraphicZone.height, false);
            }
   ...
   void renderNonInteractiveGaugeImage(Graphics var1, int var2, int var3, boolean var4) {
      ...
      if (this.maxValue == -1) {
         if (this.gaugePixmap != null) {
            ...
            Displayable.uistyle.drawGauge(var5, valueGraphicZone, var6, var7, 0, this.maxValue, this.isInteractive, var4, var8);
         }
      } else {
         Displayable.uistyle.drawGauge(var5, valueGraphicZone, var6, var7, this.value, this.maxValue, false, var4, var8);
      }
