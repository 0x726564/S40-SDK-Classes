...
public class StringItem extends Item {
   ...
   public StringItem(String var1, String var2, int var3) {
      ...
      synchronized(Display.LCDUILock) {
         ...
         case 2:
            ...
            this.setFontImpl(new Font(ITEM_VALUE_ZONE.getFont()));
   ...
   int callMinimumWidth() {
      ...
      var1 += this.str != null && !isStringEmpty(this.strNLconsidered) ? this.ellipsisWidth : (this.isFocusable() ? this.getEmptyStringWidth(this.font) : this.ellipsisWidth);
   ...
   int callPreferredWidth(int var1) {
      ...
      if (this.lockedWidth != -1) {
         ...
         if (this.strNLconsidered != null && !isStringEmpty(this.strNLconsidered)) {
            var2 += this.font.stringWidth(this.strNLconsidered);
            ...
            var2 = this.isFocusable() ? var2 + this.getEmptyStringWidth(this.font) : var2;
   ...
   int callMinimumHeight() {
      ...
      if ((this.strNLconsidered == null || isStringEmpty(this.strNLconsidered)) && this.isFocusable()) {
         Font var2 = this.appearanceMode == 1 ? this.getPaintFont() : this.font;
   ...
   int callPreferredHeight(int var1) {
      ...
      if (this.lockedHeight != -1) {
         ...
         if (this.strNLconsidered != null && !isStringEmpty(this.strNLconsidered)) {
            ...
            Font var3 = this.appearanceMode == 1 ? this.getPaintFont() : this.font;
   ...
   void callPaint(Graphics var1, int var2, int var3, boolean var4) {
      ...
      if (this.strNLconsidered != null && !isStringEmpty(this.strNLconsidered) || this.isFocusable()) {
         ...
         if (this.isButton()) {
            ...
            Displayable.uistyle.drawBorder(var11, var9, var10, this.contentWidth, var6, UIStyle.BORDER_TYPE_8, var4);
   ...
   void paintNotOffsetStringLines(com.nokia.mid.impl.isa.ui.gdi.Graphics var1, int var2, int var3, boolean var4, ColorCtrl var5, int var6, int var7) {
      if (!this.textLines.isEmpty()) {
         ...
         var1.drawTextInArea(var2, var3, var6, var7, this.textLines, this.owner.alignedLeftToRight ? 1 : 3);
   ...
   void paintOffsetStringLines(com.nokia.mid.impl.isa.ui.gdi.Graphics var1, int var2, int var3, boolean var4, ColorCtrl var5) {
      ...
      var1.drawTextInArea(var2, var3, this.currentOffsetWidth, var6, this.textLinesOffset, this.owner.alignedLeftToRight ? 1 : 3);
   }
   ...
   int callGetLayout() {
      ...
      int var3 = this.owner.alignedLeftToRight ? 1 : 2;
      switch(var1) {
      case 0:
         var1 = var2 | var3;
         break;
   ...
   private void setFontImpl(Font var1) {
      ...
      if (var1 != this.font || var1 == null) {
         ...
         this.paintFont = null;
         this.ellipsisWidth = var1.stringWidth(ELIIPSIS_STRING);
         this.emptyStringWidth = this.getEmptyStringWidth(var1);
         this.lineHeight = this.minimumLineHeight = var1.getHeight() + TextBreaker.DEFAULT_TEXT_LEADING;
      }
