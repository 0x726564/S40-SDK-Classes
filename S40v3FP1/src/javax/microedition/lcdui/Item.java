...
public abstract class Item {
   ...
   static final com.nokia.mid.impl.isa.ui.gdi.Font LABEL_FONT_IMPL;
   static final String ellipsisString;
   static int MIN_LABEL_WIDTH;
   static final int LABEL_PAD;
   int[] bounds;
   boolean hasFocus;
   boolean visible;
   boolean sizeChanged;
   ...
   int getLabelHeight(int var1) {
      return this.itemLabel == null ? 0 : this.itemLabel.labelHeight;
   }
   ...
   int callGetLayout() {
      ...
      int var2 = this.owner.alignedLeftToRight ? 1 : 2;
      switch(var1) {
      case 0:
         var1 = 16 | var2;
         break;
   ...
   static {
      ...
      LABEL_FONT = Font.getFont(0, 1, 0);
      LABEL_FONT_IMPL = Displayable.uistyle.getZone(20).getFont();
      ellipsisString = TextDatabase.getText(34);
      MIN_LABEL_WIDTH = LABEL_FONT.charsWidth(ellipsisString.toCharArray(), 0, ellipsisString.length());
      LABEL_PAD = UIStyle.LABEL_PAD;
      VALID_LAYOUT = 32563;
   }
   ...
   class Label {
      ...
      void defineLabelTextLines(int var1) {
         ...
         TextBreaker.breakTextInArea(var1, Item.MAX_LABEL_HEIGHT, 1, Item.LABEL_FONT_IMPL, var2, TextBreaker.DEFAULT_TEXT_LEADING, true, true, this.textLines, true);
      ...
      void computeLabelHeightAndWidth(int var1) {
         ...
         if (this.textLines != null && this.textLines.size() != 0) {
            ...
            this.labelHeight = var3 * this.textLines.size() + Item.LABEL_PAD;
         }
      }
      ...
      int paintLabel(Graphics var1) {
         if (Item.isStringEmpty(this.labelStrNL)) {
            ...
            var4.drawTextInArea(Item.this.owner.alignedLeftToRight ? var2 : var2 + Item.this.bounds[2] - this.labelWidth, var3, this.labelWidth, this.labelHeight, this.textLines, Item.this.owner.alignedLeftToRight ? 1 : 3);
            var1.translate(0, this.labelHeight);
