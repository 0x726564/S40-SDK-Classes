...
public class ChoiceGroup extends Item implements Choice {
   ...
   private void implPopupPaint(Graphics var1, int var2, int var3, int var4, int var5) {
      ...
      if (UIStyle.usesBackgroundsInsteadOfBorders()) {
         Displayable.uistyle.drawBorder(var1.getImpl(), var2, var3, var4, var5, 99, this.hasFocus);
      } else if (this.hasFocus) {
         Displayable.uistyle.drawBorder(var1.getImpl(), var2, var3, var4, var5, UIStyle.BORDER_TYPE_2, this.hasFocus);
      }
