...
class DateFieldInlineEditor implements DateEditor {
   ...
   public void paintDateField(Graphics var1, int var2, int var3, boolean var4) {
      ...
      int var8 = var7;
      int var11 = DATEFIELD_DATE_EDIT_ZONE.getBorderType();
      byte var12 = 0;
      if (var4) {
         DateInputField var13 = (DateInputField)this.owner.dateInputFields.elementAt(this.owner.highlight);
         if (var13 != null) {
            if (var13.getType() == 1) {
               var12 = 1;
      ...
      if (this.owner != null && var6 <= var1.getHeight() && var6 + this.getHeight() >= 0) {
         com.nokia.mid.impl.isa.ui.gdi.Graphics var18 = var1.getImpl();
         ...
         ColorCtrl var14 = var18.getColorCtrl();
         var14.setBgColor(UIStyle.COLOUR_BACKGROUND);
         var14.setFgColor(UIStyle.COLOUR_TEXT);
         if (this.owner.inputMode == 3) {
            ...
            Displayable.uistyle.drawBorder(var1.getImpl(), var5 + DATEFIELD_DATE_EDIT_ZONE.x, var6 + DATEFIELD_DATE_EDIT_ZONE.y, DATEFIELD_DATE_EDIT_ZONE.width, DATEFIELD_DATE_EDIT_ZONE.height, var11, var12 == 1);
            Displayable.uistyle.drawBorder(var1.getImpl(), var5 + DATEFIELD_TIME_EDIT_ZONE.x, var6 + DATEFIELD_TIME_EDIT_ZONE.y, DATEFIELD_TIME_EDIT_ZONE.width, DATEFIELD_TIME_EDIT_ZONE.height, var11, var12 == 2);
         } else {
            ...
            Displayable.uistyle.drawBorder(var1.getImpl(), var5 + DATEFIELD_DATE_EDIT_ZONE.x, var6 + DATEFIELD_DATE_EDIT_ZONE.y, DATEFIELD_DATE_EDIT_ZONE.width, DATEFIELD_DATE_EDIT_ZONE.height, var11, var4);
         }

         var18.setFont(DATEFIELD_DATE_EDIT_ZONE.getFont());
         int var15 = DATEFIELD_DATE_EDIT_ZONE.height - DATEFIELD_DATE_EDIT_ZONE.getMarginTop() - DATEFIELD_DATE_EDIT_ZONE.getMarginBottom();

         for(int var16 = 0; var16 < this.owner.dateInputFields.size(); ++var16) {
            DateInputField var17 = (DateInputField)this.owner.dateInputFields.elementAt(var16);
            switch(var17.getSubType()) {
            case 1:
            case 2:
            case 6:
               if (var12 == 2) {
                  var14.setBgColor(UIStyle.COLOUR_HIGHLIGHT);
                  var14.setFgColor(UIStyle.COLOUR_EDITOR_FOCUSED);
               } else {
                  var14.setBgColor(UIStyle.COLOUR_BACKGROUND);
                  var14.setFgColor(UIStyle.COLOUR_EDITOR_UNFOCUSED);
               }

               var8 += var17.render(var8, var10, var18, var15);
               break;
            case 3:
            case 4:
            case 5:
               ...
               var7 += var17.render(var7, var9, var18, var15);
            }
         }
   ...
   public boolean callTraverse(int var1, int var2, int var3, int[] var4) {
      ...
      if (var5) {
         var4[1] = this.owner.getLabelHeight(var4[1]);
