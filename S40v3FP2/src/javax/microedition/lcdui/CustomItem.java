         ...
         if (this.exceptionImageItem != null) {
            synchronized(Display.LCDUILock) {
               if (var4 && !this.isTraversable) {
                  ...
                  Displayable.uistyle.drawBorder(var1.getImpl(), var1.getTranslateX(), var1.getTranslateY() + this.exceptionImageItem.getLabelHeight(var2), this.contentWidth, var3 - this.exceptionImageItem.getLabelHeight(var2), UIStyle.BORDER_IMAGE_HIGHLIGHT, var4);
                  var1.setColor(var6);
               ...
               synchronized(Display.LCDUILock) {
                  if (var4 && !this.isTraversable && (!var7 || this.itemCommands.length() >= 1)) {
                     ...
                     if (JMS_BLENDED_HIGHLIGHT_SUPPORT) {
                        ...
                        Displayable.uistyle.drawBorder(var1.getImpl(), var1.getTranslateX(), var1.getTranslateY(), var7 ? var2 : var6, var7 ? var3 - this.labelHeight : var5, UIStyle.BORDER_IMAGE_HIGHLIGHT, var4);
                     }
