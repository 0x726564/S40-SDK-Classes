...
public class Form extends Screen {
   ...
   void callHideNotify(Display var1) {
      ...
      for(int var3 = 0; var3 < this.numOfItems; ++var3) {
         try {
            if (this.items[var3].visible) {
               this.items[var3].callHideNotify();
            }
   ...
   void callPaint(Graphics var1) {
      ...
      try {
         if (this.numOfItems == 0) {
            TextBreaker var7 = TextBreaker.getBreaker(Font.getDefaultFont().getImpl(), TextDatabase.getText(33), false);
            TextLine var8 = null;
            var8 = var7.getTextLine(32767);
            var8.setAlignment(2);
            ColorCtrl var4 = var1.getImpl().getColorCtrl();
            int var5 = var4.getFgColor();
            var4.setFgColor(UIStyle.COLOUR_TEXT);
            var1.getImpl().drawText(var8, (short)(screenNormMainZone.width / 2), (short)this.getMainZone().y);
   ...
   void deleteAllImpl() {
      this.isTallRow = false;
      this.customItemExceptionThrown = false;
      this.currentAlignment = UIStyle.isAlignedLeftToRight ? 1 : 2;
      if (this.numOfItems != 0) {
   ...
   private int findItemInRowUp(boolean var1, int var2) {
      ...
      for(var10 = -1; this.scrollingIndex >= 0 && var3.lineY == var5; var3 = this.items[this.scrollingIndex]) {
         if (this.scrollingIndex != this.traverseIndex && !var3.shouldSkipTraverse() && (var3.bounds[1] + var3.bounds[3] < var4.bounds[1] + var4.bounds[3] || var3.bounds[1] < var4.bounds[1]) && (var3.bounds[1] + var3.bounds[3] > this.view[1] - FORM_MAX_SCROLL + CELL_SPACING || this.view[1] - var3.lineY <= this.viewport[3] - FORM_MAX_SCROLL || var1)) {
   ...
   private void rightToLeftAlignementSwitch() {
      for(int var2 = 0; !UIStyle.isAlignedLeftToRight && var2 < this.numOfItems; ++var2) {
