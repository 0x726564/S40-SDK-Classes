...
class NativeTextHandler extends InlineTextHandler {
   ...
   private NativeTextHandler(TextEditor var1, int var2, int var3, String var4, String var5, int var6, boolean var7, boolean var8) {
      ...
      this.nativeHandle = this.nativeCreateNativeEditor(this.maxSize, this.constraints, var8, appId);
   ...
   public void processTextEditorEvent() {
      ...
      if (this.owner != null) {
         this.owner.processTextEditorEvent(var1);
      }
   ...
   private native int nativeCreateNativeEditor(int var1, int var2, boolean var3, int var4);
