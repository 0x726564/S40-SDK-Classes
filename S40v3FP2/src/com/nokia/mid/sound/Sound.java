...
public class Sound {
   ...
   private void initRingingTone(byte[] var1, int var2) throws IllegalArgumentException, NullPointerException {
      if (var1 == null) {
         this.status = 3;
   ...
   private void initToneBuzzer(int var1, long var2) throws IllegalArgumentException {
