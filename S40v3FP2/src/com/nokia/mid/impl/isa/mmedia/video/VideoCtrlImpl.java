...
public class VideoCtrlImpl extends Switchable implements GUIControl, VideoControl {
   ...
   private byte[] parseParamsAndGetSnapshot(String var1) throws MediaException {
      ...
      if ((var2 != -1 || var3 <= 0) && (var2 <= 0 || var3 != -1)) {
         if (var5 != null) {
            String var11 = System.getProperty("video.snapshot.encodings") + " ";
            boolean var7 = false;
            boolean var8 = false;
            int var9 = 0;

            do {
               int var12 = var11.indexOf(61, var9);
               var9 = var12 > var9 ? var11.indexOf(32, var12) : -1;
               if (var9 > 0) {
                  String var10 = var11.substring(var12 + 1, var9);
                  if (var10.equalsIgnoreCase(var5) || var10.equalsIgnoreCase("image/" + var5)) {
                     var5 = var10;
                     var7 = true;
                  }
               }
         ...
         return this.recordCtrl.getSnapshot(var2, var3, (byte)var4, var5);
      } else {
   ...
   private void getSourceDimensions(boolean var1) {
      int[] var2 = new int[]{this.srcW, this.srcH};
      nGetVideoOriginalSize(this.player.getPlayerId(), var2);
      if (var2[0] != this.srcW || var2[1] != this.srcH) {
         this.srcW = var2[0];
         this.srcH = var2[1];
         if (var1) {
            this.player.serializeEvent(6, -1L);
