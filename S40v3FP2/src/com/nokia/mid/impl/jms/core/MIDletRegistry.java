...
public class MIDletRegistry {
   ...
   public MIDletSuite findMIDletSuite(String var1, String var2) {
      if (var1 != null && var2 != null) {
         int var3 = this.findMIDletSuiteByVendorSuite(var1, var2);
         return var3 <= 0 ? null : MIDletSuite.getMIDletSuite(var3);
      } else {
         return null;
      }
   }
   ...
   public byte[] getMIDletIcon(int var1) {
      MIDletSuite var2 = MIDletSuite.getMIDletSuite(var1);
      return var2 == null ? null : var2.getIcon();
   }

   public byte[] getMIDletIcon(int var1, int var2) {
      MIDletSuite var3 = MIDletSuite.getMIDletSuite(var1);
      return var3 == null ? null : var3.getIcon(var2);
   }
   ...
   public long getSpaceUsed(int var1) {
      MIDletSuite var2 = MIDletSuite.getMIDletSuite(var1);
      return var2 == null ? 0L : var2.getSpaceUsed();
   }

   public String[] getMIDletNames(int var1) {
      MIDletSuite var2 = MIDletSuite.getMIDletSuite(var1);
      return var2 == null ? null : var2.getMIDletNames();
   }

   public int getMIDletType(int var1) {
      MIDletSuite var2 = MIDletSuite.getMIDletSuite(var1);
      return var2 == null ? 0 : var2.getMIDletType();
   }

   public String getJADProperty(int var1, String var2) {
      MIDletSuite var3 = MIDletSuite.getMIDletSuite(var1);
      return var3 == null ? null : var3.getJADProperty(var2);
   }
