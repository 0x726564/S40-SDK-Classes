      ...
      if (var0 == null) {
         ...
         if (var4 < 1) {
            ...
            try {
               ...
               if (var5.equals("file")) {
                  String var6 = UrlParser.getUriComponents(var0)[3];
                  if (var6 != null && var6.startsWith("?drm=")) {
                     var5 = "storage.drm";
                  } else {
                     var5 = "storage";
                  }
               ...
               Class var11 = Class.forName(var3 + "." + var5 + ".Protocol");
               ConnectionBaseInterface var7 = (ConnectionBaseInterface)var11.newInstance();
